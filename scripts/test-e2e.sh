...
# The per-operator screenshot is referenced from the operating guide.
if [[ "$(curl -s -o /dev/null -w '%{content_type}' "$BASE/docs/images/operators.png")" == "image/png" ]]; then
  ok "  the Operators view screenshot is served"
else
