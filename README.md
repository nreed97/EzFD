...
<tr>
<td width="50%">
  <img src="docs/images/dashboard.png" alt="Live dashboard: worked sections filled on the section map, with live rate, claimed score and sections worked down the right"><br>
